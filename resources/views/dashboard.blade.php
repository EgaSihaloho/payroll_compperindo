              ...
              <ul class="nav-menu mb-0 list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item dropdown"> <a class="nav-link text-white position-relative" id="messages" rel="nofollow" data-bs-target="#" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end mt-sm-3 shadow-sm" aria-labelledby="messages">
                    <li><a class="dropdown-item d-flex py-3" href="#!"> <img class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0" src='{{URL::asset("template/img/favicon.ico")}}'avatar-1.jpg" alt="..." width="45">
                    ...
                    <li><a class="dropdown-item d-flex py-3" href="#!"> <img class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0" src='{{URL::asset("template/img/favicon.ico")}}'avatar-2.jpg" alt="..." width="45">
                        <div class="ms-3"><span class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason Doe</span><small class="small text-gray-600"> Sent You Message</small>
                          <p class="mb-0 small text-gray-600">3 days ago at 7:58 pm - 10.06.2014</p>
                        </div></a></li>
                    <li><a class="dropdown-item d-flex py-3" href="#!"> <img class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0" src='{{URL::asset("template/img/favicon.ico")}}'avatar-3.jpg" alt="..." width="45">
                        <div class="ms-3"><span class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason Doe</span><small class="small text-gray-600"> Sent You Message</small>
                          <p class="mb-0 small text-gray-600">3 days ago at 7:58 pm - 10.06.2014</p>
                        </div></a></li>
                ...
                <div class="card-body-0">
                  <div class="collapse show" id="feeds-box" role="tabpanel">
                    ...
                    <div class="p-3 border-bottom border-gray-200">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"><img class="img-fluid rounded-circle" src='{{URL::asset("template/img/avatar-5.jpg")}}' alt="person" width="50"></a>
                          <div class="ms-3">
                    ...
                    <div class="p-3 border-bottom border-gray-200">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"><img class="img-fluid rounded-circle" src='{{URL::asset("template/img/avatar-2.jpg")}}' alt="person" width="50"></a>
                          <div class="ms-3">
                    ...
                    <div class="p-3 border-bottom border-gray-200">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"><img class="img-fluid rounded-circle" src='{{URL::asset("template/img/avatar-3.jpg")}}' alt="person" width="50"></a>
                          <div class="ms-3">
                    ...
                    <div class="p-3 border-bottom border-gray-200">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"><img class="img-fluid rounded-circle" src='{{URL::asset("template/img/avatar-1.jpg")}}' alt="person" width="50"></a>
                          <div class="ms-3">
                      ...
                      <div class="mt-3 ms-5 ps-3">
                        <div class="bg-light p-3 shadow-sm"><small class="text-gray-600">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s. Over the years.</small></div>
                    ...
                    <div class="p-3">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex"><a class="flex-shrink-0" href="#!"><img class="img-fluid rounded-circle" src='{{URL::asset("template/img/avatar-6.jpg")}}' alt="person" width="50"></a>
                          <div class="ms-3">
                  ...
                  <div class="collapse show" id="activities-box" role="tabpanel">
                    <div class="row g-0 border-bottom border-gray-200">
                      ...
                      <div class="col-sm-8 col-9 border-start border-gray-200 p-3">
                        ...
                        <p class="small mb-0 text-gray-600">
        ...
        <div class="container-fluid">
          <div class="row text-center gy-3">
            ...
            <div class="col-sm-6 text-sm-end">
              ...
              <!-- Please do not remove the backlink to us unless you support further themes development at https://bootstrapious.com/donate. It is part of the license conditions and it helps me to run Bootstrapious. Thank you for understanding :)-->
            </div>
          </div>
        </div>
      </footer>
